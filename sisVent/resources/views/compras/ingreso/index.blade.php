...
<div class = "row">
    <div class="col-lg-8 col-sm-8 col-xs-12">
        <h3>Listado de Ingresos <a href="ingreso/create"><button class="btn btn-success">Nuevo</button></a>
        <a href="/reporteIngresos" target=”_blank”><button class="btn btn-success">Reporte</button></a>
        </h3>
